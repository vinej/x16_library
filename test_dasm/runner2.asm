...
.report
    ...
    ldy #>.name
    jmp t_result
.stride_lo dc.b <64, <128, <256, <512
.stride_hi dc.b >64, >128, >256, >512
.name dc.b "SCREEN_ADDR", $00
...
.report
    ...
    ldy #>.name
    jmp t_result
.text dc.b $41, $C2, $30       ; 'a, 'B, '0 in PETSCII
.name dc.b "SCREEN_BLIT", $00
...
.salpha   dc.b "alpha", 0
.sbravo   dc.b "bravo", 0
.scharlie dc.b "charlie", 0
.sdelta   dc.b "delta", 0
.arr      ds 8, 0
.name     dc.b "STR_SORT", 0
...
.entry
    ...
    sta X16_P2
    jmp dir_next
.want      dc.b "TESTDATA.BIN", $00
.src       dc.b $DE, $AD, $BE, $EF
.found     dc.b 0
.buf_size  = 40
.buf       ds 40, 0
.name      dc.b "DIR_READS", $00
...
.report
    ...
    ldy #>.name
    jmp t_result
.gone      dc.b "NOSUCH.BMX"
.gone_len  = 10
.bmx       dc.b "TESTOUT.BMX"
.bmx_len   = 11
.name      dc.b "BMX_LASTERR", $00
...
.report
    ...
    ldy #>.name
    jmp t_result
.hi   dc.b 97, 98, $80, 99, 0
.s1   dc.b 65, 66, $80, 88, 0
.s2   dc.b 65, 66, 0
.name dc.b "STR_CASE_HIBYTE", 0
...
.report
    ...
    jmp t_result
.buf   dc.b "abc", 0
       ds 4, $5A             ; a guard the old 256-byte run walked over
.name  dc.b "STR_APPEND_SELF", 0
...
.report
    ...
    ldy #>.name
    jmp t_result
.name dc.b "SPRITE_POS_UNSIGNED", 0
...
.report
    ...
    ldy #>.name
    jmp t_result
.stars  dc.b "*a*a*a*a*a*a*a*a*a*a*a*a*a*a*a*a*a*a*a*a*", 0
.evil   dc.b "a*a*a*a*b", 0
.aaa    dc.b "aaaaaaaaaaaaaaaaaaaaaaaa", 0
.star1  dc.b "*", 0
.empty  dc.b 0
.lead   dc.b "*llo", 0
.hello  dc.b "hello", 0
.name   dc.b "STR_PAT_EDGE", 0
