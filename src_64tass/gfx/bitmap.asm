...
_s2_lower
    lda gc_oy
    beq _s2_done                ; same row twice: skip the mirror
    jsr bitmap_c_ymi
    bcs _s2_done
    jsr bitmap_c_hspan
_s2_done
...
bitmap_c_ypl
    ...
    lda gc_cy
    adc gc_oy
    bcs _ypl_bad                ; past 255
    cmp #GFX_HEIGHT
    bcs _ypl_bad                ; 240..255
    sta X16_P2
    clc
    rts
_ypl_bad
...
_seed_ok
    ...
    sta ff_tgt
    cmp ff_col
    beq _bail                   ; already the fill colour: no-op
...
_have_work
    ...
    jsr bitmap_f_rd
    cmp ff_tgt
    bne _main                   ; painted over since it was queued
...
_cell
    ...
    bne _break
    lda ff_seg
    bne _step                   ; already inside a run
