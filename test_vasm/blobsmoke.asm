...
; (cpu 65c02: vasm needs -c02 on the command line)
    include "dist/acme/x16lib.inc"      ; GENERATED constants + addresses
    include "core/macros.asm"           ; pure macro layer (emits no code)
...
.report
    ...
    ldy #>.name
    jmp t_result
.expect byte "65535", $00
.name   byte "BLOB_U16_TO_DEC", $00
