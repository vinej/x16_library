...
; play a sample living in banked RAM (count is 24-bit: low word, then high byte)
    ifdef X16_USE_PCM_STREAM
    macro xm_pcm_stream_start_bank
    lda #<(\1)
    sta X16_P0
    lda #>(\1)
    sta X16_P1
