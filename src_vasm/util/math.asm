...
;
; In src_acme/ the sine and arctangent tables are computed by the
; assembler at build time (!for + float()); vasm has no assembler-time
; float math, so this HAND-MAINTAINED port carries the same tables as
; pre-computed bytes. They are identical to what ACME emits.
; =====================================================================
