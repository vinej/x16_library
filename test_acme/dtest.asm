...
test_from2p24
    lda #<16777216 : sta X16_P0
    lda #>16777216 : sta X16_P1
    lda #<(16777216 >>> 16) : sta X16_P2
    lda #<(16777216 >>> 24) : sta X16_P3
    jsr d_from_s32
    lda #<c_2p24 : ldx #>c_2p24
    jsr chk_ac
    ldx #<@n : ldy #>@n
    jmp t_result
@n !text "DFROM_2P24", 0
...
test_rt_pos
    lda #<123456789 : sta X16_P0
    lda #>123456789 : sta X16_P1
    lda #<(123456789 >>> 16) : sta X16_P2
    lda #<(123456789 >>> 24) : sta X16_P3
    jsr d_from_s32
    jsr d_to_s32
    lda #<e_123 : ldx #>e_123
    jsr chk_p32
...
test_rt_neg
    lda #$00 : sta X16_P0        ; -2000000000 = $88CA6C00, loaded as bytes
    lda #$6C : sta X16_P1        ; (a 32-bit negative literal narrowed with
    lda #$CA : sta X16_P2        ;  #< does not port cleanly to 64tass)
    lda #$88 : sta X16_P3
    jsr d_from_s32
    jsr d_to_s32
    lda #<e_neg2e9 : ldx #>e_neg2e9
    jsr chk_p32
    ldx #<@n : ldy #>@n
    jmp t_result
@n !text "DRT_NEG", 0
...
; --- 1000000 -> "1000000" -------------------------------------------
test_ts_big
    lda #<1000000 : sta X16_P0
    lda #>1000000 : sta X16_P1
    lda #<(1000000 >>> 16) : sta X16_P2
    lda #<(1000000 >>> 24) : sta X16_P3
    jsr d_from_s32
    jsr d_to_str
    sta CHK_ZP : stx CHK_ZP+1
    lda #<x_1m : ldx #>x_1m
...
test_powhalf
    ...
    jsr d_to_str
    sta CHK_ZP : stx CHK_ZP+1
    lda #12 : sta strncmp_n
    lda #<x_sqrt2 : ldx #>x_sqrt2
    jsr strncmp
    ldx #<@n : ldy #>@n
    jmp t_result
@n !text "DPOW_HALF", 0
