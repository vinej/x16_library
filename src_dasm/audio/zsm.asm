...
ZSM_ERR_PCM     = 4
    ...
    SUBROUTINE
zsm_code        dc.b 0         ; the last ZSM_ERR_*, for zsm_lasterr
...
zsm_flags  dc.b 0
    SUBROUTINE
zsm_extlen dc.b 0              ; EXTCMD payload bytes still to consume
    SUBROUTINE
zsm_tmp    dc.b 0              ; zsm_silence's channel/voice walker
    IFCONST X16_USE_ZSM_PCM
    SUBROUTINE
zsm_pcm_hdrL  dc.b 0
    SUBROUTINE
zsm_pcm_hdrH  dc.b 0
    SUBROUTINE
zsm_pcm_dataL dc.b 0
    SUBROUTINE
zsm_pcm_dataH dc.b 0
    SUBROUTINE
zsm_pcm_last  dc.b 0
    SUBROUTINE
zsm_pcm_rate  dc.b 0
    SUBROUTINE
zsm_pcm_flags dc.b 0
    SUBROUTINE
zsm_ofsL      dc.b 0           ; instrument index * 16
    SUBROUTINE
zsm_ofsH      dc.b 0
    ENDIF
