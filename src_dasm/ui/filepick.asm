...
; ---- state -----------------------------------------------------------
    SUBROUTINE
fp_curdir   ds FPK_DIRMAX+1
    SUBROUTINE
fp_full     ds FPK_FULLSZ
    SUBROUTINE
fp_nm       ds FPK_NMSIZE
    SUBROUTINE
fp_nent     dc.b 0
...
; =====================================================================
    SUBROUTINE
fp_clip     ds FPK_FULLSZ    ; the file 'c remembered, absolute -- so
...
fp_clipok   dc.b 0
    SUBROUTINE
fp_buf      ds 256           ; what a copy moves at a time
    SUBROUTINE
fp_elen     dc.b 0             ; length of the text being edited
