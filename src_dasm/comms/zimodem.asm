...
; --- data ------------------------------------------------------------
zi_cfg   dc.b "ate0q0v1x1f0r1s45=3&p0&k3", $00
    SUBROUTINE
zi_atz   dc.b "atz", $00
    SUBROUTINE
zi_ati2  dc.b "ati2", $00
zi_ats45 dc.b "ats45=1", $00
    SUBROUTINE
zi_atg   dc.b "at&g", $22, $00     ; at&g"
    SUBROUTINE
zi_qcrlf dc.b $22, $0D, $0A, $00   ; " CR LF
    SUBROUTINE
zi_crlf  dc.b $0D, $0A, $00
    SUBROUTINE
zi_ok    dc.b "OK", $0D, $0A, $00
    SUBROUTINE
zi_rrerr dc.b "RROR", $0D, $0A, $00

    SUBROUTINE
zi_dest  dc.b 0, 0                 ; caller's current destination buffer
    SUBROUTINE
zi_fname dc.b 0, 0
    SUBROUTINE
zi_linebuf ds 90, 0              ; one hex line, read before decoding
