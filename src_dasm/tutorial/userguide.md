...
```asm
processor 65c02
include "x16.asm"  ; constants + macros. Emits no code.
...
Defined in `core/macros.asm`, available after `include "x16.asm"`. Macros
...
```asm
    ...
    jsr pal_load
    ...
mypal dc.w $0000, $0F00, $00F0, $000F  ; black, red, green, blue
```
