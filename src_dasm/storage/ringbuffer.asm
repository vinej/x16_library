...
RING_CAP = 8192                 ; the bank window is 8192 bytes (0..8191)
    ...
    SUBROUTINE
ring_bank dc.b 0              ; the HIRAM bank the queue owns
    SUBROUTINE
ring_fill dc.b 0, 0          ; bytes currently queued
    SUBROUTINE
ring_head dc.b 0, 0          ; where the next put goes
    SUBROUTINE
ring_tail dc.b 0, 0          ; one before where the next get comes from
