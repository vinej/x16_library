...
double_dat_norecip
    ...
    SUBROUTINE
double_dat_nosixth
    ; atan(r) = r - r^3/3 + r^5/5 - ...  Carry the power p = r((2k+1) >> 16) in
...
; ---------------------------------------------------------------------
    SUBROUTINE
d_ac  ds 8, 0                ; the packed accumulator
...
d_diff   ds 8, 0
    ...
    SUBROUTINE
d_ten    dc.b $00,$00,$00,$00,$00,$00,$24,$40   ; 10.0
    SUBROUTINE
d_one    dc.b $00,$00,$00,$00,$00,$00,$F0,$3F   ; 1.0
    SUBROUTINE
d_half   dc.b $00,$00,$00,$00,$00,$00,$E0,$3F   ; 0.5
...
d_1p5    dc.b $00,$00,$00,$00,$00,$00,$F8,$3F   ; 1.5
    SUBROUTINE
d_pihalf dc.b $18,$2D,$44,$54,$FB,$21,$F9,$3F   ; pi/2 = 1.5707963267948966
    SUBROUTINE
d_pi6    dc.b $66,$73,$2D,$38,$52,$C1,$E0,$3F   ; pi/6 = 0.5235987755982988
    SUBROUTINE
