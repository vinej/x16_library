...
#define X16_USE_SERIAL_ZIMODEM  // the WiFi/ESP32 layer (pulls SERIAL)

#import "core/sugar.asm"        // optional friendly xm_* macros (tested below)
...
test_ser_detect__report:
    ...
    jmp t_result
test_ser_detect__name: .text "SER_DETECT"
    .byte 0
...
test_ser_init__report:
    ...
    jmp t_result
test_ser_init__name: .text "SER_INIT"
    .byte 0
...
test_ser_baud16__report:
    ...
    jmp t_result
test_ser_baud16__name: .text "SER_BAUD16"
    .byte 0
...
test_ser_select__report:
    ...
    jmp t_result
test_ser_select__name: .text "SER_SELECT"
    .byte 0
...
test_ser_rx_empty__report:
    ...
    jmp t_result
test_ser_rx_empty__name: .text "SER_RX_EMPTY"
    .byte 0
...
test_ser_put__report:
    ...
    jmp t_result
test_ser_put__name: .text "SER_PUT"
    .byte 0
...
test_zi_hexdecode__report:
    ...
    jmp t_result
test_zi_hexdecode__name: .text "ZI_HEXDECODE"
    .byte 0
test_zi_hexdecode__hex: .text "DEADBEEF01"
test_zi_hexdecode__out: .fill 8, 0
...
test_zi_cmd:
    ...
    jmp t_result
test_zi_cmd__name: .text "ZI_CMD"
    .byte 0
test_zi_cmd__cmd: .text "ati"
    .byte 0
...
test_serial_sugar__report:
    ...
    jmp t_result
test_serial_sugar__name: .text "SERIAL_SUGAR"
    .byte 0
sugar_hex: .text "BEEF"
sugar_out: .fill 4, 0
