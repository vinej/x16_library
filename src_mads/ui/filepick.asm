...
filepick_alldef
    dta c'*.*', 0
filepick_footdef
    dta c'double click opens   esc closes', 0
filepick_dirtag
    dta c'[dir] ', 0
filepick_dattag
    dta c'[dat] ', 0
...
filepick_s_delete
    dta c'delete? y/n: ', 0
filepick_s_copyfail
    dta c'copy failed -- press a key', 0
filepick_s_swr
    dta c',S,W', 0  ; PETSCII: ACME would read ",s,w" as ASCII
