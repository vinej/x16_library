...
; mads note: to bind shapes to a non-default engine (e.g. 8bpp),
; set SHP_CUSTOM = 1 before sourcing this file and define SHP_PSET /
; SHP_HLINE / SHP_READ / SHP_W / SHP_H yourself. (mads's .def treats the
; forward references below as "defined", so a plain .if !.def SHP_PSET
; would not work.)
.if !.def SHP_CUSTOM
SHP_PSET  = gfx2_pset
SHP_READ  = gfx2_read
