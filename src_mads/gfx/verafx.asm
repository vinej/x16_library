...
fx_fill
    ...
    lda X16_T1
    ora X16_T2
    beq fx_fill__tail                   ; fewer than four bytes
...
fx_affine_on
    ...
    lda X16_P2
    and #$01
    beq fx_affine_on__tb_low
    lda #%00100000              ; address bit 16 -> value bit 5
fx_affine_on__tb_low
    ora X16_T0
    asl
    ...
    lda X16_P5
    and #$01
    beq fx_affine_on__mb_low
    lda #%00100000
fx_affine_on__mb_low
    ora X16_T0
    asl
    asl
    sta X16_T0
...
fx_affine_span
    ...
    ldy X16_P1
    txa
    beq fx_affine_span__full
    iny
fx_affine_span__full
fx_affine_span__span
    lda VERA_DATA1
    sta VERA_DATA0
    dex
    bne fx_affine_span__span
    dey
    bne fx_affine_span__span
    rts
...
fx_line__program
    ...
    bra fx_line__count                  ; would eat the line's first minor-step
...
fx_triangle__go
    ...
    lda fxt_n1
    bne fx_triangle__two_parts
    jmp fx_triangle__flat_top               ; out of branch range from here
fx_triangle__two_parts
...
fx_triangle__pos
    ...
    lda fxt_n2
    bne fx_triangle__have_part2
    jmp fx_off                  ; flat bottom: one part was the triangle
fx_triangle__have_part2
...
fx_triangle__flat_top
    ...
    cmp tri_x1+1
    bne fx_triangle__ft_pick
    lda tri_x0
    cmp tri_x1
fx_triangle__ft_pick
    bcc fx_triangle__ft_v0_left
    ...
    lda tri_x0+1
    sta fxt_py+1
    bra fx_triangle__ft_run
fx_triangle__ft_v0_left
...
fxt_len__plong
    ...
    and #$C0
    cmp #$C0
    beq fxt_len__pskip                  ; bits 9+8 set: negative width, no row
    lda fxt_fl
    lsr
    and #$0F
    sta fxt_len
...
fxt_len__pdraw
    ...
    txa
    ora fxt_len+1
    beq fxt_len__pskip                  ; zero-width row
    txa
    beq fxt_len__pfull
    iny
fxt_len__pfull
