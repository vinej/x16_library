...
test_ser_detect
    jsr ser_detect
    bcs _fail                   ; carry clear = at least one found
    cmp #2                      ; A = count
    bne _fail
...
test_zi_hexdecode
    lda #<_out                  ; destination pointer in P0/P1
    sta X16_P0
    lda #>_out
    sta X16_P1
    ...
    cmp #$01
    bne _fail
    lda _out+5                  ; one past the run: untouched
    bne _fail
    lda #0
    bra _report
_fail
...
_report
    ...
    ldy #>_name
    jmp t_result
_name .text "ZI_HEXDECODE", 0
_hex  .text "DEADBEEF01"
_out  .fill 8, 0
