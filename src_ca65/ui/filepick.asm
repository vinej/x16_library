...
; ---- state -----------------------------------------------------------
fp_curdir   .res FPK_DIRMAX+1
fp_full     .res FPK_FULLSZ
fp_nm       .res FPK_NMSIZE
fp_nent     .byte 0
fp_sel      .byte 0
fp_top      .byte 0
fp_down     .byte 0
...
; =====================================================================
fp_clip     .res FPK_FULLSZ    ; the file 'c' remembered, absolute -- so
...
filepick_s_swr
    .byte ",S,W", 0     ; PETSCII: ACME would read ",s,w" as ASCII
