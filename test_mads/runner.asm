...
test_fill__report
    ...
    ldy #>test_fill__name
    jmp t_result
test_fill__name dta c'VERA_FILL', $00
...
test_fill_zero
    ...
    jmp t_result
test_fill_zero__name dta c'VERA_FILL_ZERO_COUNT', $00
...
test_fill_stride__report
    ...
    jmp t_result
test_fill_stride__name dta c'VERA_INC_STRIDE', $00
...
test_copy__report
    ...
    ldy #>test_copy__name
    jmp t_result
test_copy__name dta c'VERA_COPY', $00
...
test_dcsel_preserves_addrsel__report
    ...
    jmp t_result
test_dcsel_preserves_addrsel__name dta c'DCSEL_KEEPS_ADDRSEL', $00
...
test_has_fx__report
    ...
    jmp t_result
test_has_fx__name dta c'VERA_HAS_FX', $00
...
test_border__report
    ...
    jmp t_result
test_border__name dta c'SCREEN_BORDER', $00
...
test_palette__report
    ...
    jmp t_result
test_palette__name dta c'PAL_SET', $00
...
test_sprite_pos__report
    ...
    jmp t_result
test_sprite_pos__name dta c'SPRITE_POS', $00
...
test_sprite_image__report
    ...
    jmp t_result
test_sprite_image__name dta c'SPRITE_IMAGE', $00
...
test_mul88__report
    ...
    jmp t_result
test_mul88__name dta c'MUL88', $00
...
test_mul88_negative__report
    ...
    jmp t_result
test_mul88_negative__name dta c'MUL88_SIGNED', $00
...
test_collide_overlap__report
    ...
    jmp t_result
test_collide_overlap__name dta c'COLLIDE_OVERLAP', $00
...
test_collide_apart__report
    ...
    jmp t_result
test_collide_apart__name dta c'COLLIDE_APART', $00
...
test_collide_touching__report
    ...
    jmp t_result
test_collide_touching__name dta c'COLLIDE_TOUCHING', $00
...
test_collide16__report
    ...
    jmp t_result
test_collide16__name dta c'COLLIDE16', $00
...
test_tile_addr__report
    ...
    jmp t_result
test_tile_addr__name dta c'TILE_ADDR', $00
...
test_tile_roundtrip__report
    ...
    jmp t_result
test_tile_roundtrip__name dta c'TILE_ROUNDTRIP', $00
...
test_irq_hook__name dta c'IRQ_HOOK', $00
...
test_vsync_counter__name   dta c'VSYNC_COUNTER', $00
...
test_fx_mult__report
    ...
    jmp t_result
test_fx_mult__name dta c'FX_MULT', $00
...
test_fx_mult_signed__report
    ...
    jmp t_result
test_fx_mult_signed__name dta c'FX_MULT_SIGNED', $00
...
test_fx_accum_dirty__report
    ...
    jmp t_result
test_fx_accum_dirty__name dta c'FX_ACCUM_RESET', $00
...
test_fx_fill__report
    ...
    jmp t_result
test_fx_fill__name dta c'FX_FILL', $00
...
test_bank_roundtrip__dst
    :(8) dta 0
test_bank_roundtrip__saved .byte 0
test_bank_roundtrip__name  dta c'BANK_ROUNDTRIP', $00
...
test_bank_boundary__name  dta c'BANK_BOUNDARY', $00
...
test_gfx_pset__report
    ...
    jmp t_result
test_gfx_pset__name dta c'GFX8L_PSET', $00
...
test_gfx_clip__report
    ...
    jmp t_result
test_gfx_clip__name dta c'GFX8L_CLIP', $00
...
test_gfx_vline__report
    ...
    jmp t_result
test_gfx_vline__name dta c'GFX8L_VLINE', $00
...
test_gfx_line__report
    ...
    jmp t_result
test_gfx_line__name dta c'GFX8L_LINE', $00
...
test_psg_regs__report
    ...
    jmp t_result
test_psg_regs__name dta c'PSG_REGS', $00
...
test_pcm_rate_clamp__report
    ...
    jmp t_result
test_pcm_rate_clamp__name dta c'PCM_RATE_CLAMP', $00
...
test_ym_write__report
    ...
    jmp t_result
test_ym_write__name dta c'YM_WRITE', $00
...
test_ym_channel_in_a__report
    ...
    jmp t_result
test_ym_channel_in_a__name dta c'YM_CHANNEL_IN_A', $00
...
test_number_dec__report
    ...
    jmp t_result
test_number_dec__max  dta c'65535', $00
test_number_dec__zero dta c'0', $00
test_number_dec__thou dta c'1000', $00
test_number_dec__name dta c'NUMBER_DEC', $00
...
test_number_hex__report
    ...
    jmp t_result
test_number_hex__beef dta c'BEEF', $00
test_number_hex__name dta c'NUMBER_HEX', $00
...
test_number_parse__report
    ...
    jmp t_result
test_number_parse__good dta c'1234'
test_number_parse__bad  dta c'12A4'
test_number_parse__name dta c'NUMBER_PARSE', $00
...
test_i16_arith
    ...
    jmp t_result
test_i16_arith__name dta c'I16_ARITH', $00
...
test_i16_divmod
    ...
    jmp t_result
test_i16_divmod__name dta c'I16_DIVMOD', $00
...
test_i16_divmod_s
    ...
    jmp t_result
test_i16_divmod_s__name dta c'I16_DIVMOD_S', $00
...
test_i16_cmp__report
    ...
    jmp t_result
test_i16_cmp__name dta c'I16_CMP', $00
...
test_i16_sqrt
    ...
    jmp t_result
test_i16_sqrt__name dta c'I16_SQRT', $00
...
test_i16_to_dec__report
    ...
    jmp t_result
test_i16_to_dec__max    dta c'65535', $00
test_i16_to_dec__minus1 dta c'-1', $00
test_i16_to_dec__min    dta c'-32768', $00
test_i16_to_dec__pos    dta c'1234', $00
test_i16_to_dec__name   dta c'I16_TO_DEC', $00
...
test_i32_addsub
    ...
    jmp t_result
test_i32_addsub__name dta c'I32_ADDSUB', $00
...
test_i32_mul
    ...
    jmp t_result
test_i32_mul__name dta c'I32_MUL', $00
...
test_i32_divmod
    ...
    jmp t_result
test_i32_divmod__name dta c'I32_DIVMOD', $00
...
test_i32_cmp__report
    ...
    jmp t_result
test_i32_cmp__name dta c'I32_CMP', $00
...
test_i32_to_dec__report
    ...
    jmp t_result
test_i32_to_dec__max  dta c'4294967295', $00
test_i32_to_dec__zero dta c'0', $00
test_i32_to_dec__mil  dta c'1000000', $00
test_i32_to_dec__name dta c'I32_TO_DEC', $00
...
test_f_roundtrip__report
    ...
    jmp t_result
test_f_roundtrip__tmp
    :(FP_SIZE) dta 0
test_f_roundtrip__name dta c'F_ROUNDTRIP', $00
...
test_f_sub_order__report
    ...
    jmp t_result
test_f_sub_order__three
    :(FP_SIZE) dta 0
test_f_sub_order__name  dta c'F_SUB_ORDER', $00
...
test_f_div_order__report
    ...
    jmp t_result
test_f_div_order__four
    :(FP_SIZE) dta 0
test_f_div_order__hundred
    :(FP_SIZE) dta 0
test_f_div_order__expect  dta c'.04', $00
test_f_div_order__name    dta c'F_DIV_ORDER', $00
...
test_f_sqrt__report
    ...
    jmp t_result
test_f_sqrt__name dta c'F_SQRT', $00
...
test_f_str__report
    ...
    jmp t_result
test_f_str__str  dta c'2.5'
test_f_str__two
    :(FP_SIZE) dta 0
test_f_str__name dta c'F_STR', $00
...
test_fs_roundtrip__report
    ...
    jmp t_result
test_fs_roundtrip__fname     dta c'TESTDATA.BIN'
test_fs_roundtrip__fname_len = 12
test_fs_roundtrip__src       .byte $DE, $AD, $BE, $EF, $CA, $FE, $BA, $BE
test_fs_roundtrip__dst
    :(8) dta 0
test_fs_roundtrip__name      dta c'FS_ROUNDTRIP', $00
...
test_cls_clears__report
    ...
    jmp t_result
test_cls_clears__name dta c'CLS_CLEARS', $00
...
test_color_reaches_vram__name dta c'COLOR_TO_VRAM', $00
...
test_vera_set_addr
    ...
    jmp t_result
test_vera_set_addr__name dta c'VERA_SET_ADDR', $00
...
test_vera_addr_decr
    ...
    jmp t_result
test_vera_addr_decr__name dta c'VERA_ADDR_DECR', $00
...
test_copy_zero
    ...
    jmp t_result
test_copy_zero__name dta c'VERA_COPY_ZERO', $00
...
test_fill_page
    ...
    jmp t_result
test_fill_page__name dta c'VERA_FILL_PAGE', $00
...
test_pal_load__name   dta c'PAL_LOAD', $00
...
test_pal_load_zero__name dta c'PAL_LOAD_ZERO', $00
...
test_sprite_zdepth
    ...
    jmp t_result
test_sprite_zdepth__name dta c'SPRITE_ZDEPTH', $00
...
test_sprite_size_pal
    ...
    jmp t_result
test_sprite_size_pal__name dta c'SPRITE_SIZE_PAL', $00
...
test_sprite_enable__name  dta c'SPRITE_ENABLE', $00
...
test_layer_enable__name  dta c'LAYER_ENABLE', $00
...
test_layer_scroll
    ...
    jmp t_result
test_layer_scroll__name dta c'LAYER_SCROLL', $00
...
test_gfx_clear_full
    ...
    jmp t_result
test_gfx_clear_full__name dta c'GFX8L_CLEAR_FULL', $00
...
test_gfx_hline_long
    ...
    jmp t_result
test_gfx_hline_long__name dta c'GFX8L_HLINE_LONG', $00
...
test_gfx_rect
    ...
    jmp t_result
test_gfx_rect__name dta c'GFX8L_RECT', $00
...
test_gfx_frame
    ...
    jmp t_result
test_gfx_frame__name dta c'GFX8L_FRAME', $00
...
test_gfx_line_steep
    ...
    jmp t_result
test_gfx_line_steep__name dta c'GFX8L_LINE_STEEP', $00
...
test_umul16_edge
    ...
    jmp t_result
test_umul16_edge__name dta c'UMUL16_EDGE', $00
...
test_mul88_frac
    ...
    jmp t_result
test_mul88_frac__name dta c'MUL88_FRAC', $00
...
test_collide8_9bit__report
    ...
    jmp t_result
test_collide8_9bit__name dta c'COLLIDE8_9BIT', $00
...
test_bit_put__name dta c'BIT_PUT', $00
...
test_i16_convert
    ...
    jmp t_result
test_i16_convert__name dta c'I16_CONVERT', $00
...
test_i16_mul_neg
    ...
    jmp t_result
test_i16_mul_neg__name dta c'I16_MUL_NEG', $00
...
test_i32_shift
    ...
    jmp t_result
test_i32_shift__name dta c'I32_SHIFT', $00
...
test_i32_convert
    ...
    jmp t_result
test_i32_convert__name dta c'I32_CONVERT', $00
...
test_number_hex_low__report
    ...
    jmp t_result
test_number_hex_low__expect dta c'000A', $00
test_number_hex_low__name   dta c'NUMBER_HEX_LOW', $00
...
test_number_parse_edge__report
    ...
    jmp t_result
test_number_parse_edge__max  dta c'65535'
test_number_parse_edge__zero dta c'0'
test_number_parse_edge__name dta c'NUMBER_PARSE_EDGE', $00
...
test_f_neg_cmp__report
    ...
    jmp t_result
test_f_neg_cmp__five
    :(FP_SIZE) dta 0
test_f_neg_cmp__name dta c'F_NEG_CMP', $00
...
test_f_pow__ten
    :(FP_SIZE) dta 0
test_f_pow__expect dta c'1024', $00
test_f_pow__name   dta c'F_POW', $00
...
test_f_ln_exp__report
    ...
    jmp t_result
test_f_ln_exp__name dta c'F_LN_EXP', $00
...
test_f_int_floor__report
    ...
    jmp t_result
test_f_int_floor__str  dta c'-2.5'
test_f_int_floor__name dta c'F_INT_FLOOR', $00
...
test_psg_note_off
    ...
    jmp t_result
test_psg_note_off__name dta c'PSG_NOTE_OFF', $00
...
test_pcm_fifo__report
    ...
    jmp t_result
test_pcm_fifo__name dta c'PCM_FIFO', $00
...
test_key_empty__report
    ...
    jmp t_result
test_key_empty__name dta c'KEY_EMPTY', $00
...
test_fs_missing__report
    ...
    jmp t_result
test_fs_missing__fname     dta c'NOFILE.XYZ'
test_fs_missing__fname_len = 10
test_fs_missing__dst
    :(2) dta 0
test_fs_missing__name      dta c'FS_MISSING', $00
...
test_prg_entry__report
    ...
    jmp t_result
test_prg_entry__fname     dta c'PRGSTUB.PRG'
test_prg_entry__fname_len = 11
; $0801 load address, link, line 10, SYS, spaces, "2071", terminators
test_prg_entry__stub      .byte $01, $08, $0C, $08, $0A, $00, $9E, $20, $20
           dta c'2071'
           .byte $00, $00, $00
test_prg_entry__stub_len  = 16
test_prg_entry__name      dta c'PRG_ENTRY', $00
...
test_prg_entry_bad__report
    ...
    jmp t_result
test_prg_entry_bad__fname     dta c'TESTDATA.BIN'
test_prg_entry_bad__fname_len = 12
test_prg_entry_bad__gone      dta c'NOFILE.XYZ'
...
test_fs_vload__report
    ...
    jmp t_result
test_fs_vload__fname     dta c'TESTDATA.BIN'
test_fs_vload__fname_len = 12
test_fs_vload__name      dta c'FS_VLOAD', $00
...
test_bank_poke__name  dta c'BANK_POKE', $00
...
test_bank_zero_count__name  dta c'BANK_ZERO_COUNT', $00
...
test_screen_mode_rt__name  dta c'SCREEN_MODE_RT', $00
...
test_screen_cursor__report
    ...
    jmp t_result
test_screen_cursor__name dta c'SCREEN_CURSOR', $00
...
test_screen_puts_vram
    ...
    jmp t_result
test_screen_puts_vram__text dta c'HI', $00
test_screen_puts_vram__name dta c'SCREEN_PUTS', $00
...
test_mem_fill__buf
    :(42) dta 0
test_mem_fill__name dta c'MEM_FILL', $00
...
test_mem_copy__dst2
    :(8) dta 0
test_mem_copy__name dta c'MEM_COPY', $00
...
test_mem_crc__report
    ...
    jmp t_result
test_mem_crc__check dta c'123456789'
test_mem_crc__name  dta c'MEM_CRC', $00
...
test_mem_decompress__report
    ...
    jmp t_result
test_mem_decompress__expect dta c'X16LIB-DECOMPRESS-TEST!!'
...
test_mem_decompress__out
    :(97) dta 0
test_mem_decompress__name   dta c'MEM_DECOMPRESS', $00
...
test_bank_copy_far__name  dta c'BANK_COPY_FAR', $00
...
test_bank_alloc__report
    ...
    jmp t_result
test_bank_alloc__name dta c'BANK_ALLOC', $00
...
test_irq_line_regs__handler
    rts
test_irq_line_regs__name dta c'IRQ_LINE_REGS', $00
...
test_irq_line_fires__name   dta c'IRQ_LINE_FIRES', $00
...
test_sprcol_regs__report
    ...
    jmp t_result
test_sprcol_regs__name dta c'SPRCOL_REGS', $00
...
test_fx_line__go
    ...
    jmp t_result
test_fx_line__name dta c'FX_LINE', $00
...
test_fx_triangle__go
    ...
    jmp t_result
test_fx_triangle__name dta c'FX_TRIANGLE', $00
...
test_pcm_stream__report
    ...
    jmp t_result
test_pcm_stream__name dta c'PCM_STREAM', $00
...
test_irq_remove_aflow__report
    ...
    jmp t_result
test_irq_remove_aflow__name dta c'IRQ_REMOVE_AFLOW', $00
...
test_irq_save_regs__report
    ...
    jmp t_result
test_irq_save_regs__name dta c'IRQ_SAVE_REGS', $00
...
test_math_rnd__name  dta c'MATH_RND', $00
...
test_math_sin__report
    ...
    jmp t_result
test_math_sin__name dta c'MATH_SIN', $00
...
test_math_atan2__report
    ...
    jmp t_result
test_math_atan2__name dta c'MATH_ATAN2', $00
...
test_math_lerp__report
    ...
    jmp t_result
test_math_lerp__name dta c'MATH_LERP', $00
...
test_clip_line__report
    ...
    jmp t_result
test_clip_line__name dta c'CLIP_LINE', $00
...
test_gfx_text__h      dta c'H', $00
test_gfx_text__rowbuf
    :(8) dta 0
test_gfx_text__name   dta c'GFX8L_TEXT', $00
...
test_psg_env__vol2                           ; A = voice 2's volume/pan shadow byte
    ...
    lda VERA_DATA1
    rts
test_psg_env__name dta c'PSG_ENV', $00
...
test_fx_copy__report
    ...
    jmp t_result
test_fx_copy__name dta c'FX_COPY', $00
...
test_fx_transp__report
    ...
    jmp t_result
test_fx_transp__name dta c'FX_TRANSP', $00
...
test_buffers__name dta c'BUFFERS', $00
...
test_adpcm__out
    :(32) dta 0
test_adpcm__name   dta c'ADPCM', $00
...
test_dos__report
    ...
    ldy #>test_dos__name
    jmp t_result
test_dos__badcmd  dta c'X9'
test_dos__dirname dta c'TDIR'
test_dos__fname   dta c'TESTDOS.BIN'
test_dos__fname2  dta c'TESTREN.BIN'
test_dos__name    dta c'DOS', $00
...
test_bmx__fname  dta c'TEST.BMX'
test_bmx__fname2 dta c'JUNK.BMX9'
test_bmx__junk   .byte $DE, $AD, $DE, $AD, $DE, $AD, $DE, $AD
        .byte $DE, $AD, $DE, $AD, $DE, $AD, $DE, $AD
test_bmx__name   dta c'BMX', $00
...
test_bmx_missing__fname     dta c'NOSUCH.BMX'
test_bmx_missing__fname_len = 10
test_bmx_missing__name      dta c'BMX_MISSING', $00
...
test_bmx_truncated__file_len  = 26

test_bmx_truncated__fname     dta c'TRUNC.BMX'
test_bmx_truncated__fname_len = 9
test_bmx_truncated__name      dta c'BMX_TRUNCATED', $00
...
test_bmx_short_pal__file_len  = 18

test_bmx_short_pal__fname     dta c'SHORTPAL.BMX'
test_bmx_short_pal__fname_len = 12
test_bmx_short_pal__name      dta c'BMX_SHORT_PAL', $00
...
test_zx0__report
    ...
    ldy #>test_zx0__name
    jmp t_result
test_zx0__expect dta c'X16LIB-DECOMPRESS-TEST!!'
...
test_tsc__report
    ...
    ldy #>test_tsc__name
    jmp t_result
test_tsc__expect dta c'X16LIB-DECOMPRESS-TEST!!'
test_tsc__redge  dta c'RLE-EDGE'
...
test_fx_affine__report
    ...
    jmp t_result
test_fx_affine__name dta c'FX_AFFINE', $00
...
test_pcm_stream_bank__name  dta c'PCM_STREAM_BANK', $00
...
test_pcm_stream_loop__report
    ...
    jmp t_result
test_pcm_stream_loop__name dta c'PCM_STREAM_LOOP', $00
...
test_gfx_read8
    ...
    ldy #0
test_gfx_read8__report
    tya
    ldx #<test_gfx_read8__name
    ldy #>test_gfx_read8__name
    jmp t_result
test_gfx_read8__name dta c'GFX8L_READ8', 0
...
test_gfx_pat8
    ...
    bne test_gfx_pat8__report
    ldy #0
test_gfx_pat8__report
    tya
    ldx #<test_gfx_pat8__name
    ldy #>test_gfx_pat8__name
    jmp t_result
test_gfx_pat8__name dta c'GFX8L_PAT8', 0
...
test_gfx_blit8
    ...
    ldx #120
    jsr rd8
    bne test_gfx_blit8__report                 ; the $00 copies over the witness now
    ldy #0
test_gfx_blit8__report
    tya
    ldx #<test_gfx_blit8__name
    ldy #>test_gfx_blit8__name
    jmp t_result
test_gfx_blit8__name dta c'GFX8L_BLIT8', 0
