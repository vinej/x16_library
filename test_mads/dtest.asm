...
test_fromm2
    ...
    ldy #>test_fromm2__n
    jmp t_result
test_fromm2__n dta c'DFROM_M2', 0
...
test_from2p24
    ...
    jmp t_result
test_from2p24__n dta c'DFROM_2P24', 0
...
test_rt_pos
    ...
    ldy #>test_rt_pos__n
    jmp t_result
test_rt_pos__n dta c'DRT_POS', 0
...
test_rt_neg
    ...
    ldy #>test_rt_neg__n
    jmp t_result
test_rt_neg__n dta c'DRT_NEG', 0
...
test_negabs__report
    ...
    ldy #>test_negabs__n
    jmp t_result
test_negabs__n dta c'DNEGABS', 0
...
test_addexp
    ...
    ldy #>test_addexp__n
    jmp t_result
test_addexp__n dta c'DADD_EXP', 0
...
test_cancel
    ...
    ldy #>test_cancel__n
    jmp t_result
test_cancel__n dta c'DCANCEL', 0
...
test_addbig
    ...
    ldy #>test_addbig__n
    jmp t_result
test_addbig__n dta c'DADD_BIG', 0
...
test_mulint
    ...
    ldy #>test_mulint__n
    jmp t_result
test_mulint__n dta c'DMUL_INT', 0
...
test_mulneg
    ...
    ldy #>test_mulneg__n
    jmp t_result
test_mulneg__n dta c'DMUL_NEG', 0
...
test_divfrac
    ...
    ldy #>test_divfrac__n
    jmp t_result
test_divfrac__n dta c'DDIV_FRAC', 0
...
test_divhalf
    ...
    ldy #>test_divhalf__n
    jmp t_result
test_divhalf__n dta c'DDIV_HALF', 0
...
test_str_int
    ...
    ldy #>test_str_int__n
    jmp t_result
test_str_int__n dta c'DSTR_INT', 0
...
test_str_neg
    ...
    ldy #>test_str_neg__n
    jmp t_result
test_str_neg__n dta c'DSTR_NEG', 0
...
test_str_big
    ...
    ldy #>test_str_big__n
    jmp t_result
test_str_big__n dta c'DSTR_BIG', 0
...
test_str_frac
    ...
    jmp t_result
test_str_frac__n dta c'DSTR_FRAC', 0
...
test_str_half
    ...
    jmp t_result
test_str_half__n dta c'DSTR_HALF', 0
...
test_str_exp
    ...
    ldy #>test_str_exp__n
    jmp t_result
test_str_exp__n dta c'DSTR_EXP', 0
...
test_ts_int
    ...
    ldy #>test_ts_int__n
    jmp t_result
test_ts_int__n dta c'DTS_INT', 0
...
test_ts_neg
    ...
    ldy #>test_ts_neg__n
    jmp t_result
test_ts_neg__n dta c'DTS_NEG', 0
...
test_ts_frac
    ...
    ldy #>test_ts_frac__n
    jmp t_result
test_ts_frac__n dta c'DTS_FRAC', 0
...
test_ts_half
    ...
    ldy #>test_ts_half__n
    jmp t_result
test_ts_half__n dta c'DTS_HALF', 0
...
test_ts_big
    ...
    ldy #>test_ts_big__n
    jmp t_result
test_ts_big__n dta c'DTS_BIG', 0
...
test_sqrt144
    ...
    ldy #>test_sqrt144__n
    jmp t_result
test_sqrt144__n dta c'DSQRT144', 0
...
test_sqrt1m
    ...
    ldy #>test_sqrt1m__n
    jmp t_result
test_sqrt1m__n dta c'DSQRT_1M', 0
...
test_sqrtneg
    ...
    ldy #>test_sqrtneg__n
    jmp t_result
test_sqrtneg__n dta c'DSQRT_NEG', 0
...
test_powhalf
    ...
    ldy #>test_powhalf__n
    jmp t_result
test_powhalf__n dta c'DPOW_HALF', 0
...
test_powint__report
    ...
    ldy #>test_powint__n
    jmp t_result
test_powint__n dta c'DPOW_INT', 0
...
test_sinhalfpi
    ...
    jmp t_result
test_sinhalfpi__n dta c'DSIN_HPI', 0
...
x_1s   dta c'1', 0
x_0s   dta c'0', 0
x_e    dta c'2.71828182845'
x_ln2  dta c'0.693147180559'
