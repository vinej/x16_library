...
test_screen_scode__report
    ...
    jmp t_result
test_screen_scode__name dta c'SCREEN_SCODE', $00
...
test_screen_addr__name dta c'SCREEN_ADDR', $00
...
test_screen_blit__name dta c'SCREEN_BLIT', $00
...
test_screen_scroll__report
    ...
    jmp t_result
test_screen_scroll__name dta c'SCREEN_SCROLL', $00
...
test_g2_pset__report
    ...
    jmp t_result
test_g2_pset__name dta c'G2_PSET', $00
...
test_g2_read__report
    ...
    jmp t_result
test_g2_read__name dta c'G2_READ', $00
...
test_g2_hline__report
    ...
    jmp t_result
test_g2_hline__name dta c'G2_HLINE', $00
...
test_g2_hline_short__report
    ...
    jmp t_result
test_g2_hline_short__name dta c'G2_HLINE_SHORT', $00
...
test_g2_vline__report
    ...
    jmp t_result
test_g2_vline__name dta c'G2_VLINE', $00
...
test_g2_rect__report
    ...
    jmp t_result
test_g2_rect__name dta c'G2_RECT', $00
...
test_g2_frame__report
    ...
    jmp t_result
test_g2_frame__name dta c'G2_FRAME', $00
...
test_g2_line__report
    ...
    jmp t_result
test_g2_line__name dta c'G2_LINE', $00
...
test_g2_pattern__report
    ...
    jmp t_result
test_g2_pattern__name dta c'G2_PATTERN', $00
...
test_g2_pattern_phase__report
    ...
    jmp t_result
test_g2_pattern_phase__name dta c'G2_PATTERN_PH', $00
...
test_g2_blit__report
    ...
    jmp t_result
test_g2_blit__name dta c'G2_BLIT', $00
...
test_g2_blitm__report
    ...
    jmp t_result
test_g2_blitm__name dta c'G2_BLITM', $00
...
test_g2_clear__report
    ...
    jmp t_result
test_g2_clear__name dta c'G2_CLEAR', $00
...
test_g2_init__report
    ...
    jmp t_result
test_g2_init__name dta c'G2_INIT', $00
...
test_shape_rrect__report
    ...
    jmp t_result
test_shape_rrect__name dta c'SHAPE_RRECT', 0
...
test_shape_stadium__report
    ...
    jmp t_result
test_shape_stadium__name dta c'SHAPE_STADIUM', 0
...
test_shape_arc__report
    ...
    jmp t_result
test_shape_arc__name dta c'SHAPE_ARC', 0
...
test_shape_pie__report
    ...
    jmp t_result
test_shape_pie__name dta c'SHAPE_PIE', 0
...
test_str_sort__report
    ...
    jmp t_result
test_str_sort__salpha   dta c'alpha', 0
test_str_sort__sbravo   dta c'bravo', 0
test_str_sort__scharlie dta c'charlie', 0
test_str_sort__sdelta   dta c'delta', 0
test_str_sort__arr
    :(8) dta 0
test_str_sort__name     dta c'STR_SORT', 0
...
test_dir_reads__entry
    ...
    sta X16_P2
    jmp dir_next
test_dir_reads__want      dta c'TESTDATA.BIN', $00
test_dir_reads__src       .byte $DE, $AD, $BE, $EF
test_dir_reads__found     .byte 0
test_dir_reads__buf_size  = 40
test_dir_reads__buf
    :(40) dta 0
test_dir_reads__name      dta c'DIR_READS', $00
...
test_dir_chdir__report
    ...
    jmp t_result
test_dir_chdir__sub       dta c'dirtest'
test_dir_chdir__sub_len   = 7
test_dir_chdir__root      dta c'//'
test_dir_chdir__root_len  = 2
test_dir_chdir__dirs      .byte 0
test_dir_chdir__others    .byte 0
test_dir_chdir__buf_size  = 40
test_dir_chdir__buf
    :(40) dta 0
test_dir_chdir__name      dta c'DIR_CHDIR', $00
...
test_bmx_lasterr__report
    ...
    jmp t_result
test_bmx_lasterr__gone      dta c'NOSUCH.BMX'
test_bmx_lasterr__gone_len  = 10
...
test_sprite_pos_signed__report
    ...
    jmp t_result
test_sprite_pos_signed__name dta c'SPRITE_POS_UNSIGNED', 0
