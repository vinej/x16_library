...
@row
    ...
    ora bmx_rows+1
    beq @done
    jsr .point_cur2             ; VERA_2 addr = bmx_cur, INC_1

    lda bmx_row
    sta bmx_cnt
    lda bmx_row+1
    sta bmx_cnt+1
    jsr .bulk_read2             ; the whole row, MACPTR into VERA2_DATA
    bcc @row_done
    jmp @io_short
@row_done
    clc                         ; cur += 640 (20-bit)
...
; port is already aimed). Same MACPTR streaming trick as .bulk_read,
