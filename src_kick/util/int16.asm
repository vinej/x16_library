...
i16_from_s8:
    sta i16_a
    and #$80
    beq i16_from_s8__positive
    lda #$FF
    sta i16_a+1
    rts
i16_from_s8__positive:
    stz i16_a+1
    rts
...
i16_cmps:
    ...
    lda i16_a+1
    bmi i16_cmps__a_negative
    lda #1                      // a >= 0, b < 0
    rts
i16_cmps__a_negative:
    lda #$FF
    rts

// ---------------------------------------------------------------------
// i16_mul -- i16_a = i16_a * i16_b, modulo 2((16) >> 16)
//
...
i16_divmod__loop:
    ...
    sbc i16_b+1
    sta i16_tmp+1
    bcc i16_divmod__next                   // did not fit: leave r alone
...
i16_divmod_s__go:
    ...
    sbc i16_b+1
    sta i16_b+1
i16_divmod_s__b_positive:

    jsr i16_divmod              // unsigned |a| / |b|; b is nonzero

    lda i16_rsign
    bpl i16_divmod_s__quotient
    ...
    sbc i16_r+1
    sta i16_r+1
i16_divmod_s__quotient:
    lda i16_qsign
    bpl i16_divmod_s__done
    jsr i16_neg
i16_divmod_s__done:
    clc
    rts
...
i16_to_dec_s:
    ...
    sbc i16_a+1
    sta X16_P1
    bra i16_to_dec_s__convert
i16_to_dec_s__positive:
    lda i16_a
    sta X16_P0
    lda i16_a+1
    sta X16_P1
i16_to_dec_s__convert:
    jsr u16_to_dec              // digits land in num_buf

    ldx #0
    lda i16_sign
    beq i16_to_dec_s__copy
    lda #'-'
    sta i16_buf
    ldx #1
i16_to_dec_s__copy:
...
i16_to_dec_s__loop:
    ...
    sta i16_buf,x
    beq i16_to_dec_s__done
    inx
    iny
    bra i16_to_dec_s__loop
i16_to_dec_s__done:
    txa
