...
i32_from_s16:
    ...
    txa
    and #$80
    beq i32_from_s16__positive
    lda #$FF                    // negative: fill the top with ones
    sta i32_a+2
    sta i32_a+3
    rts
i32_from_s16__positive:
    stz i32_a+2
    stz i32_a+3
    rts
...
i32_cmps:
    ...
    lda i32_a+3
    bmi i32_cmps__a_negative
    lda #1                      // a >= 0, b < 0
    rts
i32_cmps__a_negative:
    lda #$FF
    rts

// ---------------------------------------------------------------------
// i32_mul -- i32_a = i32_a * i32_b, modulo 2((32) >> 16)
//
...
i32_divmod__loop:
    ...
    sbc i32_b+3
    sta i32_tmp+3
    bcc i32_divmod__restore                // it did not fit: leave r alone
...
i32_to_dec__reverse:
    ...
    sty i32_hi
    cpx i32_hi
    bcs i32_to_dec__done                   // pointers met or crossed
    lda i32_buf,x
    pha
    lda i32_buf,y
    sta i32_buf,x
