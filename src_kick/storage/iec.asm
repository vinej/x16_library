...
.label IEC_CMD_DATA = $60             // secondary data channel command base
.label IEC_CMD_CLOSE = $E0             // close channel command base
.label IEC_CMD_OPEN = $F0             // open channel command base
