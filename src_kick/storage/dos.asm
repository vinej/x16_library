...
dos_cmd__read:
    ...
    beq dos_cmd__got
    cpy #(DOS_MSG_MAX - 1)
    bcs dos_cmd__skip                   // overlong: keep draining, stop storing
    sta dos_msg,y
    iny
dos_cmd__skip:
    jsr READST
    beq dos_cmd__read                   // keep going while the stream is alive
dos_cmd__got:
    lda #0
    sta dos_msg,y
    phy
...
.label DOS_MSG_MAX = 64
.label DOS_CMD_MAX = 80
