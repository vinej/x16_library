...
.label FS_SA_ADDR = 0                // skip the header, load at the caller's address
.label FS_SA_HEADER = 1                // skip it, load at the header's own address
.label FS_SA_RAW = 2                // no header: load the whole file at the address
