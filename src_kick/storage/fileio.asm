...
.label FIO_DEV_KEYBOARD = 0
.label FIO_DEV_SCREEN = 3
.label FIO_DEV_DISK = 8
.label FIO_LFN_COMMAND = 15
.label FIO_SA_NONE = 0
.label FIO_SA_COMMAND = 15
...
fio_open_write:
    jsr fio_open_named
    bcs fio_open_write__done
    ldx X16_P3
    jmp CHKOUT
fio_open_write__done:
    rts
