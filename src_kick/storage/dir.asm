...
.label DIR_LFN = 3                     // logical file: clear of fs_load's 1 and
                                // of the command channel's 15

.label DIR_TYPE_NONE = 0               // no name on the line: "BLOCKS FREE."
.label DIR_TYPE_PRG = 1
.label DIR_TYPE_SEQ = 2
.label DIR_TYPE_USR = 3
.label DIR_TYPE_REL = 4
.label DIR_TYPE_DIR = 5
.label DIR_TYPE_HOST = 6               // the header line naming the volume
