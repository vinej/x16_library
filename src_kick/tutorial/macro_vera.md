...
The macros in this file are thin KickAssembler macros around the routines in
`src_kick/video/vera.asm`. They load immediate arguments into registers and then
