...
spi_read_bytes:
    lda r1L
    ora r1H
    beq spi_read_bytes__done
spi_read_bytes__loop:
    jsr spi_read
    ldy #0
    sta (r0),y
    inc r0L
    bne spi_read_bytes__dec
    inc r0H
spi_read_bytes__dec:
    lda r1L
    bne spi_read_bytes__dec_lo
    dec r1H
spi_read_bytes__dec_lo:
    dec r1L
    lda r1L
    ora r1H
    bne spi_read_bytes__loop
spi_read_bytes__done:
    rts
...
spi_write_bytes:
    lda r1L
    ora r1H
    beq spi_write_bytes__done
spi_write_bytes__loop:
    ldy #0
    lda (r0),y
    jsr spi_write
    inc r0L
    bne spi_write_bytes__dec
    inc r0H
spi_write_bytes__dec:
    lda r1L
    bne spi_write_bytes__dec_lo
    dec r1H
spi_write_bytes__dec_lo:
    dec r1L
    lda r1L
    ora r1H
    bne spi_write_bytes__loop
spi_write_bytes__done:
    rts
