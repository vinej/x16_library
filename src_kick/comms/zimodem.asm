...
zi_hex_chunk__data:
    ...
    lda X16_P5
    bne zi_hex_chunk__notdata                // longer than 255: not a payload line
    lda X16_P4                  // digits = line length minus the CR/LF
    sec
    sbc #2
    bcc zi_hex_chunk__notdata                // shorter than the CR/LF itself
    beq zi_hex_chunk__notdata                // nothing but the CR/LF
    tay
    lsr
    bcs zi_hex_chunk__notdata                // odd digit count: not hex payload
    jsr zimodem_zi_allhex              // and every digit must really be hex
    bcs zi_hex_chunk__notdata
...
// --- data ------------------------------------------------------------
zi_cfg: .text "ate0q0v1x1f0r1s45=3&p0&k3"
    .byte $00
zi_atz: .text "atz"
    .byte $00
zi_ati2: .text "ati2"
    .byte $00
zi_ats45: .text "ats45=1"
    .byte $00
zi_atg: .text "at&g"
    .byte $22
    .byte $00
