...
.label KBD_MOD_SHIFT = %00000001
.label KBD_MOD_ALT = %00000010       // Commodore/Alt
.label KBD_MOD_CTRL = %00000100
.label KBD_MOD_CAPS = %00010000
.label KBD_MOD_ALTGR = KBD_MOD_ALT | KBD_MOD_CTRL
