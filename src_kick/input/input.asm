...
// byte 0
.label JOY_B = %10000000
.label JOY_Y = %01000000
.label JOY_SELECT = %00100000
.label JOY_START = %00010000
.label JOY_UP = %00001000
.label JOY_DOWN = %00000100
.label JOY_LEFT = %00000010
.label JOY_RIGHT = %00000001
// byte 1
.label JOY_A = %10000000
.label JOY_X = %01000000
.label JOY_L = %00100000
.label JOY_R = %00010000

.label JOY_PRESENT = $00
.label JOY_ABSENT = $FF
