...
.label GRAPH_STYLE_UNDERLINE = %10000000
.label GRAPH_STYLE_BOLD = %01000000
.label GRAPH_STYLE_REVERSE = %00100000
.label GRAPH_STYLE_ITALIC = %00010000
.label GRAPH_STYLE_OUTLINE = %00001000
.label GRAPH_STYLE_PLAIN = %00000000
