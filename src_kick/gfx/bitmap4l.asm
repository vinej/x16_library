...
.label GFX4L_WIDTH = 320
.label GFX4L_HEIGHT = 240
.label GFX4L_STRIDE = 160

// ---------------------------------------------------------------------
// gfx4l_init -- program 320x240@4bpp on bare VERA registers.
// ---------------------------------------------------------------------
#if !X16_BITMAP4L_NO_INIT
gfx4l_init:
    vera_dcsel(0)
...
gfx4l_hline:
    ...
    sta g4l_n+1
    ora g4l_n
    beq gfx4l_hline__done
gfx4l_hline__gh4l_loop:
    jsr gfx4l_pset
    inc X16_P0
    bne gfx4l_hline__nextx
    inc X16_P1
gfx4l_hline__nextx:
    sec
    lda g4l_n
...
gfx4l_vline:
    lda X16_P4
    beq gfx4l_vline__done
gfx4l_vline__gv4l_loop:
    jsr gfx4l_pset
    inc X16_P2
    dec X16_P4
    bne gfx4l_vline__gv4l_loop
gfx4l_vline__done:
    rts
...
gfx4l_frame:
    ldx #6
gfx4l_frame__gf4l_take:
    lda X16_P0,x
    sta gb4l_x,x
    dex
    bpl gfx4l_frame__gf4l_take
    ...
    sta X16_P1
    lda X16_P0
    bne gfx4l_frame__gf4l_no_borrow
    dec X16_P1
gfx4l_frame__gf4l_no_borrow:
    dec X16_P0
    jsr gfx4l_vline
    rts
...
gfx4l_blit:
    ...
    sta g4l_src+1
    lda g4l_w
    beq gfx4l_blit__gb4l_none
    lda g4l_h                   // height 0 used to fall into dec/bne and
    bne gfx4l_blit__gb4l_nonzero           // blit 256 rows of marching source memory
gfx4l_blit__gb4l_none:
    rts

gfx4l_blit__gb4l_nonzero:
...
gfx4l_blit__gb4l_row:
    ...
    lda g4l_w
    sta g4l_n
gfx4l_blit__gb4l_col:
    ldy #0
    lda (X16_PTR3),y
    sta g4l_ink
    lda g4l_phase
    beq gfx4l_blit__gb4l_bit_even
    lda g4l_ink
    and #$0F
    bra gfx4l_blit__gb4l_bit_done
gfx4l_blit__gb4l_bit_even:
    lda g4l_ink
    and #$F0
    lsr
    lsr
    lsr
    lsr
gfx4l_blit__gb4l_bit_done:
    sta g4l_ink
    jsr gfx4l_read
    sta g4l_t
    lda g4l_op
    beq gfx4l_blit__gb4l_copy
    cmp #1
    beq gfx4l_blit__gb4l_or
    cmp #2
    beq gfx4l_blit__gb4l_and
gfx4l_blit__gb4l_xor:
    lda g4l_ink
    eor g4l_t
    bra gfx4l_blit__gb4l_store
gfx4l_blit__gb4l_and:
    lda g4l_ink
    and g4l_t
    bra gfx4l_blit__gb4l_store
gfx4l_blit__gb4l_or:
    lda g4l_ink
    ora g4l_t
gfx4l_blit__gb4l_store:
    sta X16_P3
    jsr gfx4l_pset
    bra gfx4l_blit__gb4l_next_x
gfx4l_blit__gb4l_copy:
    lda g4l_ink
    sta X16_P3
    jsr gfx4l_pset
    bra gfx4l_blit__gb4l_next_x
gfx4l_blit__gb4l_next_x:
    inc X16_P0
    bne gfx4l_blit__gb4l_carry1
    inc X16_P1
gfx4l_blit__gb4l_carry1:
    lda g4l_phase
    and #1
    beq gfx4l_blit__gb4l_flip_phase
    inc X16_PTR3
    bne gfx4l_blit__gb4l_flip_phase
    inc X16_PTR3+1
gfx4l_blit__gb4l_flip_phase:
    eor #1
    sta g4l_phase
    dec g4l_n
    beq gfx4l_blit__gb4l_end_row
    jmp gfx4l_blit__gb4l_col
gfx4l_blit__gb4l_end_row:
    lda g4l_src
    clc
    adc g4l_rowbytes
    sta g4l_src
    ...
    sta g4l_y0
    dec g4l_h
    beq gfx4l_blit__gb4l_done
    jmp gfx4l_blit__gb4l_row
gfx4l_blit__gb4l_done:
    rts
...
gfx4l_blitm:
    ...
    sta g4l_src+1
    lda g4l_w
    beq gfx4l_blitm__gm4l_none
    lda g4l_h                   // as gfx4l_blit: height 0 is a no-op, not
    bne gfx4l_blitm__gm4l_nonzero           // 256 rows
gfx4l_blitm__gm4l_none:
    rts

gfx4l_blitm__gm4l_nonzero:
...
gfx4l_blitm__gm4l_row:
    ...
    lda g4l_w
    sta g4l_n
gfx4l_blitm__gm4l_col:
    ldy #0
    lda (X16_PTR3),y
    sta g4l_ink
    lda g4l_phase
    beq gfx4l_blitm__gm4l_px_even
    lda g4l_ink
    and #$0F
    bra gfx4l_blitm__gm4l_px_done
gfx4l_blitm__gm4l_px_even:
    lda g4l_ink
    and #$F0
    lsr
    lsr
    lsr
    lsr
gfx4l_blitm__gm4l_px_done:
    beq gfx4l_blitm__gm4l_skip
    sta X16_P3
    jsr gfx4l_pset
gfx4l_blitm__gm4l_skip:
    inc X16_P0
    bne gfx4l_blitm__gm4l_carry1
    inc X16_P1
gfx4l_blitm__gm4l_carry1:
    lda g4l_phase
    and #1
    beq gfx4l_blitm__gm4l_flip_phase
    inc X16_PTR3
    bne gfx4l_blitm__gm4l_flip_phase
    inc X16_PTR3+1
gfx4l_blitm__gm4l_flip_phase:
    eor #1
    sta g4l_phase
    dec g4l_n
    bne gfx4l_blitm__gm4l_col
    lda g4l_src
    clc
    adc g4l_rowbytes
    sta g4l_src
    ...
    sta g4l_y0
    dec g4l_h
    beq gfx4l_blitm__gm4l_done
    jmp gfx4l_blitm__gm4l_row
gfx4l_blitm__gm4l_done:
    rts
...
gfx4l_line:
    ldx #6
gfx4l_line__gl4l_take:
    lda X16_P0,x
    sta gl4l_x0,x
    dex
    bpl gfx4l_line__gl4l_take
    ...
    sta gl4l_sx
    sta gl4l_sx+1
    bra gfx4l_line__gl4l_dx_done
gfx4l_line__gl4l_dx_pos:
    lda #$01
    sta gl4l_sx
    stz gl4l_sx+1
gfx4l_line__gl4l_dx_done:

    sec                         // dy = -|y1 - y0|, sy = sign.  y is
    lda gl4l_y1                 // UNSIGNED 8-bit (0-239), so the sign is
    sbc gl4l_y0                 // the carry, not bit 7: bpl read |dy| >= 128
    bcs gfx4l_line__gl4l_dy_pos            // as negative and drew upside down.
    eor #$FF
    clc
    ...
    lda #$FF
    sta gl4l_sy
    bra gfx4l_line__gl4l_dy_done
gfx4l_line__gl4l_dy_pos:
    sta gl4l_ldy
    lda #$01
    sta gl4l_sy
gfx4l_line__gl4l_dy_done:
    sec
    lda #0
    sbc gl4l_ldy
    sta gl4l_dy
...
gfx4l_line__gl4l_loop:
    jsr bitmap4l_gl4l_plot
    lda gl4l_x0
    cmp gl4l_x1
    bne gfx4l_line__gl4l_step
    lda gl4l_x0+1
    cmp gl4l_x1+1
    bne gfx4l_line__gl4l_step
    lda gl4l_y0
...
gfx4l_line__gl4l_step:
    ...
    lda gl4l_e2+1
    sbc gl4l_dy+1
    bvc gfx4l_line__gl4l_nv1
    eor #$80
gfx4l_line__gl4l_nv1:
    bmi gfx4l_line__gl4l_skip_x
    clc
    lda gl4l_err
    adc gl4l_dy
    sta gl4l_err
    ...
    adc gl4l_sx+1
    sta gl4l_x0+1
gfx4l_line__gl4l_skip_x:
    sec
    lda gl4l_dx
    sbc gl4l_e2
    lda gl4l_dx+1
    sbc gl4l_e2+1
    bvc gfx4l_line__gl4l_nv2
    eor #$80
gfx4l_line__gl4l_nv2:
    bmi gfx4l_line__gl4l_skip_y
    clc
    lda gl4l_err
    adc gl4l_dx
    sta gl4l_err
    ...
    adc gl4l_sy
    sta gl4l_y0
gfx4l_line__gl4l_skip_y:
    jmp gfx4l_line__gl4l_loop
...
gfx4l_char:
    ...
    sta VERA_ADDR_H
    ldx #0
gfx4l_char__gt4l_fetch:
    lda VERA_DATA1
    sta gt4l_glyph,x
    inx
    cpx #8
    bne gfx4l_char__gt4l_fetch
    vera_addrsel(0)
    ...
    sta gt4l_by
    stz gt4l_row
gfx4l_char__gt4l_rows:
    ldx gt4l_row
    lda gt4l_glyph,x
    sta gt4l_bits
    beq gfx4l_char__gt4l_next_row
    stz gt4l_col
gfx4l_char__gt4l_cols:
    asl gt4l_bits
    bcc gfx4l_char__gt4l_next_col
    clc
    lda gt4l_bx
    adc gt4l_col
    sta X16_P0
    ...
    lda gt4l_by
    adc gt4l_row
    bcs gfx4l_char__gt4l_next_col
    sta X16_P2
    jsr gfx4l_pset
gfx4l_char__gt4l_next_col:
    inc gt4l_col
    lda gt4l_col
    cmp #8
    bne gfx4l_char__gt4l_cols
gfx4l_char__gt4l_next_row:
    inc gt4l_row
    lda gt4l_row
    cmp #8
    bne gfx4l_char__gt4l_rows
    lda gt4l_bx
    sta X16_P0
    lda gt4l_bx+1
    sta X16_P1
...
gfx4l_text__gt4l_loop:
bitmap4l_gt4l_lda:
    lda $FFFF
    beq gfx4l_text__gt4l_done
    bit #%01000000
    beq gfx4l_text__gt4l_code_ok
    and #$1F
gfx4l_text__gt4l_code_ok:
    jsr gfx4l_char
    clc
    lda X16_P0
    adc #8
