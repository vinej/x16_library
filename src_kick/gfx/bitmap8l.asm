...
.label GFX8L_WIDTH = 320
.label GFX8L_HEIGHT = 240
...
gfx8l_pset:
    lda X16_P2
    cmp #GFX8L_HEIGHT
    bcs gfx8l_pset__off                    // y >= 240

    lda X16_P1                  // x high byte
    beq gfx8l_pset__on                     // x < 256, always on screen
    cmp #1
    bne gfx8l_pset__off                    // x >= 512
    lda X16_P0
...
gfx8l_frame__take:
    ...
    sta X16_P1
    lda X16_P0
    bne gfx8l_frame__no_borrow
    dec X16_P1
gfx8l_frame__no_borrow:
    dec X16_P0
    jsr gfx8l_vline
...
gfx8l_line__take: // laid out in the same order
    lda X16_P0,x
    sta gl8l_x0,x
    dex
    bpl gfx8l_line__take
...
gfx8l_char__rows:
    ...
    lda gt8l_glyph,x
    sta gt8l_bits
    beq gfx8l_char__next_row               // a blank row: nothing to plot
    stz gt8l_col
gfx8l_char__cols:
    asl gt8l_bits                 // leftmost pixel first
    bcc gfx8l_char__next_col
    clc
    lda gt8l_bx
    adc gt8l_col
    sta X16_P0
    ...
    lda gt8l_by
    adc gt8l_row
    bcs gfx8l_char__next_col               // wrapped past 255: off screen
    sta X16_P2
    jsr gfx8l_pset
gfx8l_char__next_col:
    inc gt8l_col
    lda gt8l_col
    cmp #8
    bne gfx8l_char__cols
gfx8l_char__next_row:
    inc gt8l_row
    lda gt8l_row
    cmp #8
    bne gfx8l_char__rows
...
gfx8l_text__code_ok:
    ...
    bne gfx8l_text__tloop
    inc bitmap8l_gt8l_lda+2
    bra gfx8l_text__tloop
gfx8l_text__tdone:
    rts
