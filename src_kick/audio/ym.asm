...
.label YM_TIMEOUT = 128                // busy-wait spins before giving up
.label YM_BUSY = %10000000          // YM_DATA bit 7 while the chip is busy
...
ym_write__wait:
    dey
    bmi ym_write__timeout
    bit YM_DATA
    bmi ym_write__wait                   // busy
