...
test_fill_zero
    ...
    ldy #>@name
    jmp t_result
@name .byte "VERA_FILL_ZERO_COUNT", $00
...
@report
    ...
    ldy #>@name
    jmp t_result
@name .byte "DCSEL_KEEPS_ADDRSEL", $00
...
@report
    ...
    ldy #>@name
    jmp t_result
@max  .byte "4294967295", $00
@zero .byte "0", $00
@mil  .byte "1000000", $00
@name .byte "I32_TO_DEC", $00
...
@report
    ...
    jmp t_result
@four    .res FP_SIZE, 0
@hundred .res FP_SIZE, 0
@expect  .byte ".04", $00
@name    .byte "F_DIV_ORDER", $00
...
@report
    ...
    ldy #>@name
    jmp t_result
@fname     .byte "TESTDATA.BIN"
@fname_len = 12
@src       .byte $DE, $AD, $BE, $EF, $CA, $FE, $BA, $BE
@dst       .res 8, 0
@name      .byte "FS_ROUNDTRIP", $00
...
@max  .byte "65535"
@zero .byte "0"
@name .byte "NUMBER_PARSE_EDGE", $00
...
@report
    ...
    ldy #>@name
    jmp t_result
@fname     .byte "NOFILE.XYZ"
@fname_len = 10
@dst       .res 2, 0
@name      .byte "FS_MISSING", $00
...
test_prg_entry
    ...
    lda #@stub_len
    sta X16_P2
    lda #@fname_len             ; t_write_file takes A/X/Y as SETNAM does
    ldx #<@fname
    ldy #>@fname
    jsr t_write_file
    bcs @fail
...
@report
    ...
    ldy #>@name
    jmp t_result
@fname     .byte "PRGSTUB.PRG"
@fname_len = 11
; $0801 load address, link, line 10, SYS, spaces, "2071", terminators
@stub      .byte $01, $08, $0C, $08, $0A, $00, $9E, $20, $20
           .byte "2071"
           .byte $00, $00, $00
@stub_len  = 16
@name      .byte "PRG_ENTRY", $00
...
@fname     .byte "TESTDATA.BIN"
@fname_len = 12
@gone      .byte "NOFILE.XYZ"
@gone_len  = 10
@name      .byte "PRG_ENTRY_BAD", $00
...
@report
    ...
    ldy #>@name
    jmp t_result
@expect .byte "X16LIB-DECOMPRESS-TEST!!"
...
@badcmd  .byte "X9"
@dirname .byte "TDIR"
@fname   .byte "TESTDOS.BIN"
@fname2  .byte "TESTREN.BIN"
@name    .byte "DOS", $00
...
@fname     .byte "NOSUCH.BMX"
@fname_len = 10
@name      .byte "BMX_MISSING", $00
...
@fname     .byte "TRUNC.BMX"
@fname_len = 9
@name      .byte "BMX_TRUNCATED", $00
...
@fname     .byte "SHORTPAL.BMX"
@fname_len = 12
@name      .byte "BMX_SHORT_PAL", $00
...
@report
    ...
    ldy #>@name
    jmp t_result
@name .byte "GFX8L_PAT8", 0
@pat .byte $F0, $F0, $F0, $F0, $F0, $F0, $F0, $F0
